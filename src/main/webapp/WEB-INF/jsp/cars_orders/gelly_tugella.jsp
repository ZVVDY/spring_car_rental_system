...
<head>
    ...
    <title>Gelly Tugella Order </title>
...
<nav>
    <div class="header">
        ...
        <div class="navigation">
            ...
            <br>
    <%--@elvariable id="gelly_tugella" type=""--%>
    <form:form method="post" modelAttribute="gelly_tugella">
            Geely Tugella, 1.6, Automatic transmission, White, 2021
        <br>
        Cost 23.70 $/hour
        <img src="../../../resources/images/Geely-Tugella-grey.png" alt="">
